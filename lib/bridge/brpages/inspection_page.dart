...
import 'package:bridgeinsp_new/bridge/brpages/inspectionsummary_tab.dart';
import 'package:bridgeinsp_new/bridge/brpages/inventory.dart';
import 'package:bridgeinsp_new/bridge/brpages/obsmaintenanceroutine_tab.dart';
import 'package:bridgeinsp_new/bridge/brpages/recordedinspection_page.dart';
import 'package:bridgeinsp_new/bridge/brpages/remedialwork_tab.dart';
...
class _InspectionPageState extends State<InspectionPage> {
  ...
  Future<void> _saveInspection() async {
    ...
    try {
      ...
      // Save photo GPS metadata locally without changing your existing
      // SendInfo or BrPostModel classes. For server synchronization, add
      // equivalent fields to the API model and database later.
      final photoMetadata = _photos.map((photo) => photo.toJson()).toList();
      await sharedPref.save(
        'bridge_photo_locations_${widget.row}',
