...
class ApiProviderDrainageidlist {
  final Dio _dio = Dio();

  // Use the correct, resolvable URL
  final String _baseUrl = 'https://teman-api.plus.com.my/c&s/drainagegi/all?id='; // Or Azure FQDN if DNS isn't fixed

  // --- REVERTED: Fetch all data for the ID ---
  Future<DrainageidlistModel> fetchDrainageidlist(String id) async {
    try {
      ...
      DrainageidlistModel result = DrainageidlistModel.fromJson(response.data);
      ...
      print("Exception in ApiProviderDrainageidlist: $error stackTrace: $stacktrace");
      rethrow; 
    }
  }
