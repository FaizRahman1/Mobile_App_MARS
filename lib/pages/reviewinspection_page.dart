...
import 'package:bridgeinsp_new/pages/inspection_detail_page.dart';

class ReviewInspectionPage extends StatefulWidget {
  final String row; // Bridge ID
...
class _ReviewInspectionPageState extends State<ReviewInspectionPage> {
  ...
  Future<void> _loadInspection() async {
    try {
      ...
      final List<BrPostModel> list = BrPostModel.decode(raw);
      ...
      if (match == null) {
        setState(() {
          _error = "No saved inspection found for Bridge ID: ${widget.row}";
          _isLoading = false;
        });
        return;
      }
