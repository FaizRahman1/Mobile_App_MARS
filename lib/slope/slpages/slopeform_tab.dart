...
class SlopeFormBloc extends FormBloc<String, String> {
  // General slope data
...
class SlopeFormTab extends StatelessWidget {
  final SlopeFormBloc formBloc;
  final bool showSubmitButton;

  SlopeFormTab({
    super.key,
    SlopeFormBloc? formBloc,
    this.showSubmitButton = false,
  }) : formBloc = formBloc ?? SlopeFormBloc();

  @override
  Widget build(BuildContext context) {
    return FormBlocListener<SlopeFormBloc, String, String>(
      formBloc: formBloc,
        ...
        child: Column(
          ...
          children: [
            ...
            _actionRequiredField(
              ...
              actionBloc:
                  formBloc.vegetationControlForm,
              descriptionBloc:
                  formBloc.vegetationControlFormdesc,
            ),
            _actionRequiredField(
              title:
                  'Desilting and clearing of debris in drain, weep holes & sumps',
              actionBloc:
                  formBloc.drainCleaningForm,
              descriptionBloc:
                  formBloc.drainCleaningFormdesc,
            ),
            _actionRequiredField(
              title:
                  'Filling of gullies and ground reinstatement to sides of drains',
              actionBloc:
                  formBloc.gullyrepairform,
              descriptionBloc:
                  formBloc.gullyrepairformdesc,
            ),
            _actionRequiredField(
              title:
                  'Minor concrete restoration (cement jointing and seal) to drains and sumps and reinstatement of collapsed drain section',
              actionBloc:
                  formBloc.concreterestorationform,
              descriptionBloc:
                  formBloc.concreterestorationformdesc,
            ),
            _actionRequiredField(
              title:
            ...
            _actionRequiredField(
              ...
              actionBloc:
                  formBloc.earthdrainresectioningform,
              descriptionBloc:
