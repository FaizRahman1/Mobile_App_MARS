class DrainageinspectionModel {
  ...
  DrainageinspectionModel.withError(String errorMessage) {
    error = errorMessage;
  }

  factory DrainageinspectionModel.fromJson(Map<String, dynamic> json) {
    return DrainageinspectionModel(
      id: json['id'],
      ...
      drainageelement: json['bridgeelement'] != null
          ? DrainageElement.fromJson(json['bridgeelement'] as Map<String, dynamic>)
          : null,
...
class DrainageElement {
  ...
  factory DrainageElement.fromJson(Map<String, dynamic> json) {
    return DrainageElement(
