...
class SlopeinventoryModel {
  ...
  SlopeinventoryModel.withError(String errorMessage) {
    error = errorMessage;
  }

  SlopeinventoryModel.fromJson(Map<String, dynamic> json) {
