...
import 'package:bridgeinsp_new/slope/slpages/slopeidlist_page.dart';
...
import 'package:bridgeinsp_new/slope/slpages/module_selection_page.dart';
...
class _SLHomePageState extends State<SLHomePage> {
  ...
  late final DatasendBloc _postBloc = DatasendBloc(SLDatasendRepos());
  ...
  Future<void> _openSearchSlopeId() async {
          ...
          onPressed: () async {
            ...
            if (again == ConnectivityResult.none) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const SelectedSLIdPage(
                    title: 'List of Selected Slope IDs for Inspection',
                  ),
                ),
              );
            } else {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const SlopeidlistPage(id: '')),
    );
  }
  ...
  void _openSelectedIds() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            const SelectedSLIdPage(title: 'List of Selected Slope IDs'),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Slope General Inspection'),
        actions: [
          IconButton(
            tooltip: 'Logout',
            onPressed: _logout,
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _HeaderCard(token: userToken, onSearch: _openSearchSlopeId),
