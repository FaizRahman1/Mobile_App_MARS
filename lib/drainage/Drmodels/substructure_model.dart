class DrainageModel {
  ...
  DrainageModel.withError(String errorMessage) {
    error = errorMessage;
  }

  DrainageModel.fromJson(Map<String, dynamic> json) {
    id = (json['id'] ?? '').toString();
    ...
    final dynamic d = json['drainage'] ?? json['dr'] ?? json['substructure'];
    drainage = (d is Map<String, dynamic>) ? Drainage.fromJson(d) : null;
  }
...
class Drainage {
  ...
  factory Drainage.fromJson(Map<String, dynamic> json) {
    return Drainage(
