...
import 'package:bridgeinsp_new/drainage/drpages/module_selection_page.dart';
...
class _DrHomePageState extends State<DrHomePage> {
  ...
  late final DatasendBloc _postBloc = DatasendBloc(DRDatasendRepos());
  ...
  Future<void> _openSearchDrainageId() async {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => const SelectedDRIdPage(
                    title: 'List of Selected Drainage IDs for Inspection',
                  ),
                ),
              );
            } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Drainage General Inspection'),
        actions: [
          IconButton(
            tooltip: 'Logout',
            onPressed: _logout,
          ...
          child: Column(
            ...
            children: [
              ...
              GridView(
                ...
                children: [
                  _ActionTile(
                    title: 'Search Drainage ID',
                    subtitle: 'Find & start inspection',
                    icon: Icons.search_rounded,
                    onTap: _openSearchDrainageId,
                  ),
                  _ActionTile(
                    title: 'Selected IDs',
                  ...
                  _ActionTile(
                    title: 'Modules',
                    subtitle: 'Switch inspection module',
      ...
      child: Column(
        ...
        children: [
          ...
          FilledButton.icon(
            ...
            label: const Text('Search Drainage ID'),
          ),
        ],
      ),
    );
